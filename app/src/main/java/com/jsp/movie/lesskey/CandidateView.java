...
import com.jsp.util.CandidateGenerator;
...
public class CandidateView extends View {
	...
	public CandidateView(Context context, DatabaseHandler dbHandler, String previous) {
		super(context);
	...
	private void onDrawCandidate (Canvas canvas) {
		mTotalWidth = 0;
	...
	public void setSuggestions(List<String> suggestions, boolean completions,
		...
		if (suggestions != null)
			new CandidateGenerator (suggestions, typedWordValid, l, dbHandler, previous).execute();
	}
